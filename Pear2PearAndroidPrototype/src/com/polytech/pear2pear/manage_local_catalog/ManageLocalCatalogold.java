 ...
 */
public class ManageLocalCatalogold extends OrmLiteBaseActivity<DatabaseHelper> {
	 ...
	 */
	public void addCatalog(final String nom_fichier,final String description_fichier, final String chemin_fichier) {
		// get our dao
	 ...
	 */
	//private List<CatalogueLocal> listCatalog(Context context)
	public void listCatalog(Context context)
	{
		final Class<CatalogueLocal> n = CatalogueLocal.class;
		RuntimeExceptionDao<CatalogueLocal, Integer> simpleDao = null;
		simpleDao = (RuntimeExceptionDao<CatalogueLocal, Integer>) getHelper().getSimpleDataDao(n);
